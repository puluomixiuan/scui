	...
	<el-container> 
		...
		<el-main class="nopadding"> 
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange"> 
				...
				<el-table-column label="测试1" prop="test1" width="100"></el-table-column> 
				 
				<el-table-column label="测试2" prop="test2" width="100"></el-table-column> 
				 
				<el-table-column label="测试3" prop="test3" width="100"></el-table-column> 
	...
	export default { 
		...
		methods: { 
			...
			async table_del(row, index){ 
				...
				// var res = await this.$API.5.post(reqData); 
				if(res.code == 200){ 
			...
			saveForm(){ 
				this.$refs.saveDialog.submit(async (formData) => { 
					this.isSaveing = true; 
					// var res = await this.$API.3.post(formData); 
